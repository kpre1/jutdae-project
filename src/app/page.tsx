      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div>
          ...
          <div className="space-y-4">
            {recentNews.map((news) => (
              <div key={news.news_id} className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">
                      <Link href={`/news/${news.news_id}`} className="hover:text-blue-600">
                        {news.title}
                      </Link>
                    </h3>
                    ...
                    <div className="flex items-center space-x-4 text-sm text-gray-500">
                      ...
                      <Link href={`/news/${news.news_id}`} className="text-blue-600 hover:underline">
                        자세히 보기
                      </Link>
                    </div>
                  </div>
